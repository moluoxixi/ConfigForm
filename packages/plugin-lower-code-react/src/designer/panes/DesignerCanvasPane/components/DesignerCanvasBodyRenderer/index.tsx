...
/**
 * Designer Canvas Body Renderer：封装该模块的核心渲染与交互逻辑。
 * 所属模块：`packages/plugin-lower-code-react/src/designer/panes/DesignerCanvasPane/components/DesignerCanvasBodyRenderer/index.tsx`。
