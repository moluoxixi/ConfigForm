...
import { setupAntd } from '../src/index.ts'

describe('ui-antd setup', () => {
  beforeEach(() => {
  ...
  it('registers field components, readPretty mapping and actions', () => {
    ...
    expect(fields.Select).toBe(componentsMock.Select)
    ...
    expect(readPretty.Switch).toBe(previewMock.PreviewSwitch)
