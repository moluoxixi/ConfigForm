      ...
      <FormProvider :form="form">
        ...
        <AFormItem label="权限分配">
          <div v-if="mode === 'readOnly'" style="display: flex; flex-wrap: wrap; gap: 4px">
            <ATag v-for="k in targetKeys" :key="k" color="blue">
...
import { FormItem as AFormItem, Input as AInput, Tag as ATag, Transfer as ATransfer } from 'ant-design-vue'
...
function handleTransferChange(keys: string[]): void {
