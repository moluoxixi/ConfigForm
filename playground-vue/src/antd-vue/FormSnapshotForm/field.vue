<template>
  <div>
    ...
    <div style="display: flex; gap: 16px">
      <div style="flex: 1"><PlaygroundForm :form="form">
        <template #default="{ form: f, mode }">
          ...
          <AButton v-if="mode === 'editable'" @click="saveDraft" style="margin-bottom: 8px">暂存草稿</AButton>
        </template>
      </PlaygroundForm></div>
...
import { Button as AButton, Space as ASpace, Input as AInput, FormItem as AFormItem, Card as ACard, Textarea as ATextarea, message } from 'ant-design-vue'
