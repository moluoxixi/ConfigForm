    ...
    <StatusTabs ref="st" v-slot="{ mode, showResult }">
      <FormProvider :form="form">
        <form novalidate @submit.prevent="handleSubmit(showResult)">
          ...
          <FormField name="gender" :field-props="{ label: '性别', component: 'Select', dataSource: GENDER_OPTIONS, componentProps: { placeholder: '请选择性别', clearable: true } }" />
...
/**
 * 场景 1：基础表单 - Field 版（Element Plus）
 *
