...
import {
  ...
  ElButton, ElFormItem, ElCard, ElDivider,
} from 'element-plus';
...
<template>
  <div>
    <h2 style="margin-bottom: 8px;">Element Plus Field 组件 - 级联联动</h2>
    ...
    <FormProvider :form="form">
      <form @submit.prevent="handleSubmit">
        ...
        <el-card shadow="never" style="margin-bottom: 20px;">
          <template #header><span style="font-weight: 600;">地址信息（三级联动）</span></template>
        ...
        <!-- 联系方式联动 -->
        <el-card shadow="never" style="margin-bottom: 20px;">
          <template #header><span style="font-weight: 600;">联系方式（类型切换联动）</span></template>
