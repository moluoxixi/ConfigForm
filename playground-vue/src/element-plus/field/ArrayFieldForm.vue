          ...
          <ElCard shadow="never" style="margin-bottom: 20px;">
            <template #header>
              <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <ElButton type="primary" size="small" :disabled="!contactsField.canAdd" @click="contactsField.push()">
                  + 添加联系人
                </ElButton>
              </div>
            </template>
            ...
            >
              ...
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                ...
                <ElButtonGroup size="small">
                  <ElButton :disabled="idx === 0" @click="contactsField.moveUp(idx)">
                    ↑
                  </ElButton>
                  <ElButton :disabled="idx === (contactsField.value as unknown[]).length - 1" @click="contactsField.moveDown(idx)">
                    ↓
                  </ElButton>
                  <ElButton :disabled="!contactsField.canAdd" @click="contactsField.duplicate(idx)">
                    复制
                  </ElButton>
                  <ElButton type="danger" :disabled="!contactsField.canRemove" @click="contactsField.remove(idx)">
                    删除
                  </ElButton>
                </ElButtonGroup>
              </div>
